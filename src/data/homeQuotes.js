const HOME_QUOTES = [
  // ========== 1. 人性欲望与动机 (Human Desires and Motivations) ==========
  ...
  // ========== 2. 自我欺骗与真相 (Self-Deception and Truth) ==========
  ...
  // ========== 3. 人性的二元性 (The Duality of Human Nature) ==========
  ...
  // ========== 6. 爱情与人际关系 (Love and Relationships) ==========
  ...
  { text: '爱是灵魂的语言，超越一切界限。', author: '泰戈尔' },

  // ========== 7. 孤独与联结 (Loneliness and Connection) ==========
  ...
  // ========== 8. 成长与蜕变 (Growth and Transformation) ==========
  ...
  // ========== 10. 存在的意义 (The Meaning of Existence) ==========
  ...
  // ========== 额外经典名言 (Additional Classic Quotes) ==========
  ...
  { text: '鱼，我所欲也；熊掌，亦我所欲也。二者不可得兼，舍鱼而取熊掌者也。', author: '孟子' },
  { text: '恻隐之心，人皆有之；羞恶之心，人皆有之；恭敬之心，人皆有之；是非之心，人皆有之。', author: '孟子' },
  { text: '天将降大任于是人也，必先苦其心志，劳其筋骨，饿其体肤，空乏其身，行拂乱其所为。', author: '孟子' },
  { text: '尽信书，则不如无书。', author: '孟子' },
  { text: '爱人者，人恒爱之；敬人者，人恒敬之。', author: '孟子' },
  { text: '权，然后知轻重；度，然后知长短。', author: '孟子' },
  { text: '人有不为也，而后可以有为。', author: '孟子' },
  { text: '心之官则思，思则得之，不思则不得也。', author: '孟子' },
  { text: '自暴者，不可与有言也；自弃者，不可与有为也。', author: '孟子' },
  { text: '我知言，我善养吾浩然之气。', author: '孟子' },
  { text: '不以规矩，不能成方圆。', author: '孟子' },
  { text: '虽有智慧，不如乘势；虽有镃基，不如待时。', author: '孟子' },
  { text: '祸福无不自己求之者。', author: '孟子' },
  { text: '大人者，不失其赤子之心者也。', author: '孟子' },
  { text: '人有鸡犬放，则知求之；有放心而不知求。', author: '孟子' },
  { text: '万物皆备于我矣。反身而诚，乐莫大焉。', author: '孟子' },
  { text: '言无实不祥。不祥之实，蔽贤者当之。', author: '孟子' },
  { text: '春秋无义战。', author: '孟子' },
  { text: '得道者多助，失道者寡助。寡助之至，亲戚畔之；多助之至，天下顺之。', author: '孟子' },
  { text: '人皆可以为尧舜。', author: '孟子' },
  { text: '君子有三乐，而王天下不与存焉。', author: '孟子' },
  { text: '君子之所以教者五：有如时雨化之者，有成德者，有达财者，有答问者，有私淑艾者。', author: '孟子' },
  { text: '大匠诲人必以规矩，学者亦必以规矩。', author: '孟子' },
  { text: '贤者以其昭昭使人昭昭，今以其昏昏使人昭昭。', author: '孟子' },
  { text: '山径之蹊间，介然用之而成路，为间不用，则茅塞之矣。', author: '孟子' },
  { text: '为高必因丘陵，为下必因川泽。', author: '孟子' },
  { text: '吾今而后知杀人亲之重也：杀人之父，人亦杀其父；杀人之兄，人亦杀其兄。', author: '孟子' },
  { text: '人告之以有过，则喜。', author: '孟子' },
  { text: '仁人无敌于天下。', author: '孟子' },
  { text: '君子之守，修其身而天下平。', author: '孟子' },
  { text: '行有不得者皆反求诸己，其身正而天下归之。', author: '孟子' },
  { text: '人有恒言，皆曰"天下国家"。天下之本在国，国之本在家，家之本在身。', author: '孟子' },
  { text: '顺天者存，逆天者亡。', author: '孟子' },
  { text: '诚者，天之道也；思诚者，人之道也。', author: '孟子' },
  { text: '至诚而不动者，未之有也；不诚，未有能动者也。', author: '孟子' },
  { text: '博学而详说之，将以反说约也。', author: '孟子' },
  { text: '以善服人者，未有能服人者也；以善养人，然後能服天下。', author: '孟子' },
  { text: '言无实不祥。不祥之实，蔽贤者当之。', author: '孟子' },
  { text: '西子蒙不洁，则人皆掩鼻而过之；虽有恶人，斋戒沐浴，则可以祀上帝。', author: '孟子' },
  { text: '君子之泽五世而斩，小人之泽五世而斩。', author: '孟子' },
  { text: '透得名利关，方是小休歇；透得生死关，方是大休歇。', author: '王阳明' },
  ...
  { text: '故立志者，为学之心也；为学者，立志之事也。', author: '王阳明' },
  { text: '谦虚其心，宏大其量。', author: '王阳明' },
  { text: '未有知而不行者。知而不行，只是未知。', author: '王阳明' },
  { text: '夫万事万物之理不外于吾心。', author: '王阳明' },
  { text: '苟无尊崇笃信之心，则必有轻忽慢易之意。', author: '王阳明' },
  { text: '吾性自足，不假外求。', author: '王阳明' },
  { text: '在事上磨炼。', author: '王阳明' },
  { text: '心即理也，天下又有心外之事，心外之理乎？', author: '王阳明' },
  { text: '悔悟是去病之药，然以改之为贵。', author: '王阳明' },
  { text: '人须在事上磨，方立得住，方能"静亦定，动亦定"。', author: '王阳明' },
  { text: '夫学贵得之心，求之于心而非也，虽其言之出于孔子，不敢以为是也。', author: '王阳明' },
  { text: '如今于凡忿懥等件，只是个物来顺应，不要着一分心思，便心体廓然大公，得其本体之正了。', author: '王阳明' },
  { text: '你未看此花时，此花与汝心同归于寂；你来看此花时，则此花颜色一时明白起来。', author: '王阳明' },
  { text: '夫过者，自大贤所不免，然不害其卒为大贤者，为其能改也。', author: '王阳明' },
  { text: '天下之事，其得之不难，则其失之必易；其积之不久，则其发之必不宏。', author: '王阳明' },
  { text: '轻财足以聚人，律己足以服人，量宽足以得人，身先足以率人。', author: '王阳明' },
  { text: '你萌时这一知处，便是你的命根；当下即去消磨，便是立命工夫。', author: '王阳明' },
  { text: '此心不动，随机而动。', author: '王阳明' },
  { text: '授书不在徒多，但贵精熟。', author: '王阳明' },
  { text: '只要晓得，如何要记得？要晓得已是落第二义了，只要明得自家本体。', author: '王阳明' },
  { text: '持志如心痛。一心在痛上，岂有工夫说闲话、管闲事。', author: '王阳明' },
  { text: '克己须要扫除廓清，一毫不存，方是。有一毫在，则众恶相引而来。', author: '王阳明' },
  { text: '为学大病在好名。', author: '王阳明' },
  { text: '是徒知静养而不用克己工夫也。如此临事，便要倾倒。', author: '王阳明' },
  { text: '善念发而知之，而充之；恶念发而知之，而遏之。', author: '王阳明' },
  { text: '功夫难处，全在格物致知上。此即"诚意"之事。', author: '王阳明' },
  { text: '道无精粗，人之所见有精粗。', author: '王阳明' },
  { text: '人若真实切己用功不已，则于此心天理之精微，日见一日。', author: '王阳明' },
  { text: '立志用功，如种树然。方其根芽，犹未有干；及其有干，尚未有枝。', author: '王阳明' },
  { text: '若己为君子，而使人为小人，亦非仁人忠恕恻怛之心。', author: '王阳明' },
  { text: '良知只是个是非之心，是非只是个好恶。', author: '王阳明' },
  { text: '圣人与天地民物同体，儒、佛、老、庄皆我之用，是之谓大道。', author: '王阳明' },
  { text: '这良知人人皆有。圣人只是保全无些障蔽，兢兢业业，亹亹翼翼，自然不息，便也是学。', author: '王阳明' },
  { text: '然可欲者是我的物，不可放失；不可欲者非是我物，不可留藏。', author: '王阳明' },
  { text: '殃莫大于叨天之功，罪莫大于掩人之善，恶莫深于袭下之能，辱莫重于忘己之耻，四者备而祸全。', author: '王阳明' },
  { text: '须是勇。用功久，自有勇。故曰「是集义所生者」，胜得容易，便是大贤。', author: '王阳明' },
  { text: '既去恶念，便是善念，便复心之本体矣。', author: '王阳明' },
  { text: '圣人之知，如青天之日；贤人如浮云天日；愚人如阴霾天日；虽有昏明不同，其能辨黑白则一。', author: '王阳明' },
  { text: '且戒惧慎独者，已以动为未尝动，则安得以静为未发而拘之乎？', author: '王阳明' },
  { text: '私意一萌，即自知觉，便与除去的功夫，亦不妨矣。', author: '王阳明' },
  { text: '故格物者，格其心之物也，格其意之物也，格其知之物也。', author: '王阳明' },
  { text: '天地生意，花草一般。何曾有善恶之分？子欲观花，则以花为善，以草为恶。', author: '王阳明' },
  { text: '与人论学，亦须随人分限所及。', author: '王阳明' },
  { text: '致知二字，乃是孔门正法眼藏，异此而学，即谓之异端；离此而说，即谓之邪说。', author: '王阳明' },
  { text: '此是人人自有，个个所成，不假于外求，自然而致者。', author: '王阳明' },
  { text: '此独知处便是诚的萌芽，此处不论善念恶念，更无虚，一是百是，一错百错。', author: '王阳明' },
  { text: '只为世上人都把生身命子看得太重，不问当死不当死，定要宛转委曲保全，以此把天理却丢去了。', author: '王阳明' },
  { text: '以事言谓之史，以道言谓之经；事即道，道即事。', author: '王阳明' },
  { text: '大抵吾人为学紧要大头脑，只是立志，所谓困忘之病，亦只是志欠真切。', author: '王阳明' },
  { text: '务要立个必为圣人之心，时时刻刻须是一棒一条痕，一掴一拳血，方能听吾说话，句句得力。', author: '王阳明' },
  { text: '人心是天渊。心之本体无所不该，原是一个天。只为私欲障碍，则天之本体失了。', author: '王阳明' },
  { text: '人若戒惧其心，不忍见其恶，便是诚的萌芽，亦便是生的端绪。', author: '王阳明' },
  { text: '苟能于此纯粹无杂处认真用工，便是做集义的工夫。', author: '王阳明' },
  { text: '道德以为之地，忠信以为之基，诚以使之为坊，礼以卫之为墉。', author: '王阳明' },
  { text: '方其根芽，犹未有干；及其有干，尚未有枝；枝而后叶，叶而后花、实。', author: '王阳明' },
  { text: '一念改过，当时即得本心。', author: '王阳明' },
  { text: '随他多少邪思枉念，这里一觉，都自消融。真个是灵丹一粒，点铁成金。', author: '王阳明' },
  { text: '若主宰定时，与天运一般不息，虽酬酢万变，常是从容自在，所谓"天君泰然，百体从令"。', author: '王阳明' },
  { text: '若不随他，只是仍旧在这里，便是存其心，便是养性，便是事天。', author: '王阳明' },
  { text: '只念念要存天理，即是立志。能不忘乎此，久则自然心中凝聚。', author: '王阳明' },
  { text: '大凡朋友须箴规指摘处少，诱掖奖劝意多，方是。', author: '王阳明' },
  { text: '到此地位，一苦一乐，皆由中出，不由外入，安得而不洒落乎？', author: '王阳明' },
  { text: '亦需廓清后方能坚定。若杂念搅时，终是立不住脚。', author: '王阳明' },
  { text: '天地气机，元无一息之停；然有个主宰，故不先不后，不急不缓。', author: '王阳明' },
  { text: '常如猫之捕鼠，一眼看着，一耳听着，才有一念萌动，即与克去。', author: '王阳明' },
  { text: '定者心之本体，天理也。动静，所遇之时也。', author: '王阳明' },
  { text: '忘己是克己工夫。', author: '王阳明' },
  { text: '后儒不明圣学，不知就自己心地良知良能上体认扩充，却去求知其所不知，求能其所不能。', author: '王阳明' },
  { text: '其实良知只是一个，随他发现流行处，当下具足，更无去来，不须假借。', author: '王阳明' },
  { text: '性是心之体，天是性之原，尽心即是尽性。', author: '王阳明' },
  { text: '喜怒哀乐，本体自是中和的。才自家着些意思，便过不及，便是私。', author: '王阳明' },
  { text: '除了人情事变，则无事矣。喜怒哀乐非人情乎？自视听言动，以至富贵贫贱、患难死生，皆事变也。', author: '王阳明' },
  { text: '诚字有以工夫说者，诚是心之本体，求复其本体，便是思诚的工夫。', author: '王阳明' },
  { text: '明理而已，何以求之于外乎？', author: '王阳明' },
  { text: '先生曰：「人若知这良知诀窍，随他多少邪思枉念，这里一觉，都自消融。」', author: '王阳明' },
  { text: '或疑知行不合一，以「知之匪艰」二句为问。先生曰：「良知自知，原是容易的。」', author: '王阳明' },
  { text: '始知圣人之道，吾性自足，向之求理于事物者误也。', author: '王阳明' },
  { text: '盖日用之间，见闻酬酢，虽千头万绪，莫非良知之发用流行。', author: '王阳明' },
  { text: '譬之树木，须先有此根，然后栽培灌溉，方得以至其繁茂也。', author: '王阳明' },
  { text: '故不贵于无过，而贵于能改过。', author: '王阳明' },
  { text: '只在此心去人欲、存天理上用功便是。', author: '王阳明' },
  { text: '日间工夫觉纷扰，则静坐；觉懒看书，则且看书。是亦因病而药。', author: '王阳明' },
  { text: '精神道德言动，大率收敛为主，发散是不得已，天地人物皆然。', author: '王阳明' },
  { text: '须是平日好色、好利、好名等项一应私心，扫除荡涤，无复纤毫留滞。', author: '王阳明' },
  { text: '君子论学，固惟是是从，然亦须虚心求教，委曲商量，庶可静听其说而审处其是非。', author: '王阳明' },
  { text: '拔本塞源之论不明于天下，则天下之学圣人者将日繁日难，斯人入于夷狄、禽兽，而犹以为圣人之学。', author: '王阳明' },
  { text: '使在我果无功利之心，虽钱谷兵甲，搬柴运水，何往而非实学？何事而非天理？', author: '王阳明' },
  { text: '为学第一工夫，要降得浮躁之气定。', author: '王阳明' },
  { text: '是故不务于诚意而徒以格物者，谓之支；不事于格物而徒以诚意者，谓之虚。', author: '王阳明' },
  { text: '然譬之燧石，非有外烁之火，则燧石亦不能自焚矣。', author: '王阳明' },
  { text: '亦不是将迎意必到得此心，才为精一；到得此心，即谓之精一。', author: '王阳明' },
  { text: '问：「近来妄念也觉少，亦觉不曾着想定要如何用功，不知此是工夫否？」先生曰：「汝且去致知。」', author: '王阳明' },
  { text: '若常人之心，如斑垢驳杂之镜，须痛加刮磨一番，尽去其驳蚀，然后纤尘即见。', author: '王阳明' },
  { text: '虽则圣贤别有真乐，而亦常人之所同有，但常人有之而不自知，反自求许多忧苦，自加迷弃。', author: '王阳明' },
  { text: '所以须有格物之功，格者，正也，正其不正以归于正之谓也。', author: '王阳明' },
  { text: '人须有为己之心，方能克己；能克己，方能成己。', author: '王阳明' },
  { text: '盖日用之间，见闻酬酢，虽千头万绪，莫非良知之发用流行；除却见闻酬酢，亦无良知可致矣。', author: '王阳明' },
  { text: '故须学以去其昏蔽；然于良知之本体，初不能有加损于毫末也。', author: '王阳明' },
  { text: '只是这良知承受得恭敬，便是恭敬；承受得非礼勿视，便是非礼勿视。', author: '王阳明' },
  { text: '吾心自有光明月，千古团圆永无缺。', author: '王阳明' },
  { text: '主宰一定，则发窍于目，而目可见；发窍于耳，而耳可听；发窍于口与四肢，而口与四肢可言动。', author: '王阳明' },
  { text: '良知原是完完全全，是的还他是，非的还他非，是非只依着他，更无有不是处，这良知还是你的明师。', author: '王阳明' },
  { text: '问：「思无邪一言，如何便盖得三百篇之义？」先生曰：「岂特三百篇？」', author: '王阳明' },
  { text: '本来面目，即吾圣门所谓良知；随物而格，是致知之功，即佛氏之「常惺惺」，亦是常存他本来面目耳。', author: '王阳明' },
  { text: '凡饮食只是要养我身，食了要消化；若徒蓄积在肚里，便成痞了，如何长得肌肤？', author: '王阳明' },
  { text: '所谓汝心，却是那能视听言动的，这个便是性，便是天理。', author: '王阳明' },
  { text: '理虽万殊而性同，故以一人之性，足以通天下之理。', author: '王阳明' },
  { text: '君子之学，以明其心。其心本无味也，而欲为之蔽，习为之害。', author: '王阳明' },
  { text: '专涵养者，日见其不足；专识见者，日见其有余。日不足者，日有余矣；日有余者，日不足矣。', author: '王阳明' },
  { text: '问：「知识不长进，如何？」先生曰：「为学须有本原，须从本原上用力，渐渐盈科而进。」', author: '王阳明' },
  { text: '譬之病疟之人，虽有时不发，而病根原不曾除，则亦不得谓之无病之人矣。', author: '王阳明' },
  { text: '若以己之良知，未得尽达于吾所事亲、从兄之间，便是诚意之功尚未纯熟。', author: '王阳明' },
  { text: '但是，再送上几句王阳明的短句，突出重点。', author: '王阳明' },
  { text: '志不立，如无舵之舟，无衔之马，漂荡奔逸，终亦何所底乎？', author: '王阳明' },
  { text: '学须反己。若徒责人，只见得人不是，不见自己非。若能反己，方见自己有许多未尽处，奚暇责人？', author: '王阳明' },
  { text: '见贤思齐焉，见不贤而内自省，则不至于责人已甚，而自治严矣。', author: '王阳明' },
  { text: '省察是有事时存养，存养是无事时省察。', author: '王阳明' },
  { text: '常快活便是功夫。', author: '王阳明' },
  { text: '种树者必培其根，种德者必养其心。', author: '王阳明' },
  { text: '凡谋其力之所不及而强其知之所不能者，皆不得为致良知。', author: '王阳明' },
  { text: '知轻傲处，便是良知；致此良知，除却轻傲，便是格物。', author: '王阳明' },
  { text: '王阳明哲学核心：心即理、知行合一、致良知。', author: '王阳明' },
  { text: '饥来吃饭倦来眠，只此修行玄更玄。说与世人浑不信，却从身外觅神仙。', author: '王阳明' },
  { text: '未有知而不行者。知而不行，只是未知。', author: '王阳明' },
  { text: '天地虽大，但有一念向善，心存良知，虽凡夫俗子，皆可为圣贤。', author: '王阳明' },
  { text: '你未看此花时，此花与汝心同归于寂；你来看此花时，则此花颜色一时明白起来。', author: '王阳明' },
  { text: '日间工夫，觉纷扰，则静坐；觉懒看书，则且看书。是亦因病而药。', author: '王阳明' },
  { text: '持志如心痛，一心在痛上，岂有功夫说闲话，管闲事。', author: '王阳明' },
  { text: '故立志者，为学之心也；为学者，立志之事也。', author: '王阳明' },
  { text: '身之主宰便是心，心之所发便是意，意之本体便是知，意之所在便是物。', author: '王阳明' },
  { text: '天地气机，元无一息之停。然有个主宰，故不先不后，不急不缓。', author: '王阳明' },
  { text: '善念发而知之，而充之；恶念发而知之，而遏之。', author: '王阳明' },
  { text: '惟一是惟精主意，惟精是惟一功夫。', author: '王阳明' },
  { text: '无善无恶心之体，有善有恶意之动，知善知恶是良知，为善去恶是格物。', author: '王阳明' },
  { text: '悔悟是去病之药，然以改之为贵。若留滞于中，则又因药发病。', author: '王阳明' },
  { text: '汝若以厌外物之心去求之静，是反养成一个骄惰之气了；汝若不厌外物，复于静处涵养，却好。', author: '王阳明' },
  { text: '在寻常日用间，第一有一念向善之心，真所谓"天君泰然"，此却是立志之意也。', author: '王阳明' },
  { text: '心即理也，此心无私欲之蔽，即是天理，不须外面添一分。', author: '王阳明' },
  { text: '志于道德者，功名不足以累其心；志于功名者，富贵不足以累其心。', author: '王阳明' },
  { text: '此心光明，亦复何言。', author: '王阳明' },
  { text: '不贵于无过，而贵于能改过。', author: '王阳明' },
  { text: '破山中贼易，破心中贼难。', author: '王阳明' },
  { text: '志不立，天下无可成之事。', author: '王阳明' },
